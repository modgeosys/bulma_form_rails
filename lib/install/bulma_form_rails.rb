...
copy_file File.join(Gem.loaded_specs['bulma_form_rails'].full_gem_path, 'lib', 'bulma_form_rails', 'javascript', 'controllers', 'child_objects_controller.js'), "app/javascript/controllers/child_objects_controller.js" 
